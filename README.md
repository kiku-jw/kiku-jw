...
<p align="center">
  <strong>I build practical tools that turn messy files, logs, messages, and media into reviewable output.</strong>
</p>

<p align="center">
  Python and TypeScript · AI automation · backend/API products · local-first workflows
</p>
